...
\definecolor{listing-comment}{rgb}{0,0.39,0}
\definecolor{listing-string}{rgb}{0.65,0.65,0.65}
\lstset{
...
\include{kapitel/voraussetzungen}
\include{kapitel/software-design}
\include{kapitel/beispiel-implementation}
\include{kapitel/probleme}
\include{kapitel/ausblick}
\include{vorspann/projektmanagement}
...
\include{anhang/selbstaendigkeitserklaerung}
%---------------------------------------------------------------------------
...
\include{datenbanken/abbreviations}
