...
\begin{textblock}{154}[0,0](28,50)
	\includegraphics[scale=1.0]{img/titelbild.jpg}			% Titelbild definieren
\end{textblock}
...
,,Ist die Umsetzung auch ineffizient, ist die Umsetzung dafür effizient.'' 			\\				% Untertitel eingeben
\vspace{5mm}

\fontsize{10pt}{12pt}\selectfont
\textbf{Bachelorthesis} \\		% eingeben
\vspace{3mm}
